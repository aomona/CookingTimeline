...
function cookingTemplate(recipes, total) {
  ...
  return `
    <div class="max-w-3xl mx-auto">
      <nav class="mb-6">
        <a href="#multi/${recipes.map(r => r.id).join(',')}" class="inline-flex items-center px-4 py-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow text-gray-700 hover:text-blue-600 border border-gray-200">
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-2xl font-bold text-gray-800">複数レシピ – 調理中</h2>
